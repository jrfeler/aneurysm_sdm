...
import coiling_img from '../images/coiling.svg'
      ...
      <Grid container={true} justify={'flex-start'} alignContent={'flex-start'} spacing={16} className={'norm_padding'}>
        ...
        <Grid className={'landing_block first'} item={true} xs={12} container={true} justify={'flex-end'}>
          ...
          <div className={size_class + ' landing_img_text'}>
            ...
            <Typography variant='body1' paragraph={true}>2 kinds of problems caused by aneurysms:
              <ul>
                <li>they can cause headaches and other issues like blurred vision, weakness, numbness, or difficulty speaking.</li>
                <li>they can <b>rupture</b>, causing a bleed in the brain that can be deadly or cause permanent brain damage.</li>
              </ul>
            </Typography>
        ...
        <Grid item={true} container={true} spacing={24} className={'landing_block'}>
          <Grid item={true} xs={12}>
            <p className={'supertitle'}>MANAGEMENT:</p>
          ...
          <Grid item={true} xs={12} sm={4} md={4} container={true} alignItems={'stretch'}>
            <Card>
              <CardActionArea>
              ...
              <CardActions>
                <Button size={'small'} style={{'margin-left':'auto'}}>Learn More</Button>
              </CardActions>
            </Card>
          ...
          <Grid item={true} xs={12} sm={4} container={true} alignItems={'stretch'}>
            <Card>
              <CardActionArea href={'#/about-surg'}>
              ...
              <CardActions style={{'margin-top':'auto'}}>
                <Button size={'small'} style={{'margin-left':'auto'}} href={'#/about-surg'}>Learn More</Button>
              </CardActions>
            </Card>
          </Grid>
        ...
        <Grid item={true} xs={12} className={'landing_block'}>
          <p className={'supertitle'}>GENERAL:</p>
